...
日本語の技術文書、設計文書、計画、PR本文、長い解説文を書く・推敲するときに使う。
`docs/` の仕様・設計や開発手順にも適用し、章や節の演出に関する規範は長い読み物に限って使う。
短いPR本文や手順では、結論と必要な根拠を先に示し、発見を遅らせる構成を持ち込まない。
...
対象文書で定義した専門用語を議論に使うのはよい。空虚な装飾として使うのが問題である。
